...
description: Build Terminal User Interfaces with Textual (multi-pane apps, widgets, CSS styling, testing) and Python Prompt Toolkit (line editing, history, completions, key bindings). Use when creating TUI dashboards, IDE-like interfaces, REPLs, command inputs with history/autocomplete, or testing TUI applications.
---
